	...
	Function = function(val, mouse)
		if mouse then
			...
			if shared.VapeDeveloper then
				...
				loadstring(game:HttpGet('https://raw.githubusercontent.com/UHrrRvrRznZOsEnYYAQUVCtdEmkPaM/VCIDDdpFwTJQyjvIcBepkltqEiXkPU/'..readfile('newvape/profiles/commit.txt')..'/loader.lua', true))()
			end
		end
	end
})
